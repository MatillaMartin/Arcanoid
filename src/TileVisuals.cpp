	...
	tileSize(tileMatrixRegion.width / nTilesWidth, tileMatrixRegion.height / nTilesHeight)
{
	...
	tileQuad.addTexCoord(ofDefaultTexCoordType(0, 0));
	tileQuad.addTexCoord(ofDefaultTexCoordType(1, 0));
	tileQuad.addTexCoord(ofDefaultTexCoordType(1, 1));
	tileQuad.addTexCoord(ofDefaultTexCoordType(0, 1));
